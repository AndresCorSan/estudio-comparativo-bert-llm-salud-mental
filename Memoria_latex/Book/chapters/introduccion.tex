...
Dentro de este contexto, el procesamiento del lenguaje natural (PLN) se ha consolidado como una de las áreas más relevantes, permitiendo el desarrollo de modelos capaces de comprender y analizar texto de forma cada vez más precisa. Modelos basados en arquitecturas \textit{transformer}, como BERT, así como los recientes grandes modelos de lenguaje (LLMs), han demostrado un alto rendimiento en tareas como la clasificación de texto, el análisis de sentimientos o la detección de emociones. Estas capacidades han favorecido su aplicación en distintos dominios, incluido el ámbito de la salud mental, donde el lenguaje puede actuar como un indicador del estado psicológico de una persona.
...
\begin{itemize}
	...
	\item Entrenar y evaluar modelos basados en BERT mediante técnicas de \textit{fine-tuning} para tareas de clasificación.
	\item Aplicar grandes modelos de lenguaje (LLMs), tanto de código abierto como propietarios, mediante estrategias de \textit{zero-shot prompting} utilizando APIs de distintos proveedores, con el fin de predecir la presencia de los distintos trastornos sin necesidad de reentrenamiento.
