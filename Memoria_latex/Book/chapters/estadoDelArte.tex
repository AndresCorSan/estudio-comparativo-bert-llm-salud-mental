...
En paralelo a estos avances, el uso del \ac{PLN} en el ámbito de la salud mental ha cobrado relevancia en los últimos años. Diversos trabajos han explorado la detección de trastornos como la depresión a partir de textos publicados en redes sociales o foros, abordando el problema como una tarea de clasificación \cite{coppersmith_clpsych_2015}. En este contexto, se han empleado tanto enfoques tradicionales basados en características lingüísticas como modelos más recientes basados en \textit{transformers} \cite{matero_suicide_2019}, obteniendo resultados prometedores. Más recientemente, algunos estudios han comenzado a explorar el uso de grandes modelos de lenguaje en este ámbito. Por ejemplo, Danner et al. \cite{danner_advancing_2023} proponen métodos basados en modelos tipo \acs{GPT} para la detección de depresión, mostrando mejoras respecto a enfoques tradicionales, mientras que Liu et al. \cite{liu_enhanced_2025} presentan un enfoque basado en \acp{LLM} optimizados para el cribado de depresión y ansiedad, evidenciando mejoras en sensibilidad y capacidad de interpretación. No obstante, la mayoría de estas investigaciones se centran principalmente en la depresión, mientras que otros trastornos, como la ansiedad o los trastornos de la conducta alimentaria, han recibido menor atención.

Asimismo, una parte significativa de los trabajos existentes se basa en datasets en inglés, lo que limita la aplicabilidad de los resultados a otros contextos lingüísticos. A esto se suma la falta de estudios que comparen de manera sistemática diferentes enfoques, especialmente en lo que respecta a la comparación entre modelos tradicionales basados en \textit{fine-tuning} y grandes modelos de lenguaje aplicados mediante \textit{prompting}. Aunque los \acsp{LLM} han comenzado a utilizarse en este ámbito, su uso sigue siendo relativamente reciente y todavía existen incertidumbres sobre su rendimiento y sus limitaciones en tareas específicas de detección de trastornos.
