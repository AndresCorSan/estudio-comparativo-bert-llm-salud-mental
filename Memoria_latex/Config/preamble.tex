  ...
  \AddToShipoutPicture*{%
    \put(0,0){%
      \parbox[b][\paperheight]{\paperwidth}{%
        \includegraphics[width=\paperwidth,height=\paperheight]{cover/imagen-portada-tfg2026.png}%
      }%
    }%
  }%
}
\newcommand\PutBackPageBackground{%
  \AddToShipoutPicture*{%
    \put(0,0){%
      \parbox[b][\paperheight]{\paperwidth}{%
        \includegraphics[width=\paperwidth,height=\paperheight]{cover/imagen-contraportada-tfg2026.png}%
      }%
    }%
  }%
}
