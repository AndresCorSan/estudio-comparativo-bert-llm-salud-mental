...
\newcommand{\myBookTitleSpanish}{Detección de ansiedad, depresión y trastornos alimenticios mediante grandes modelos de lenguaje (LLM): un estudio comparativo entre BERT y modelos de última generación}
\newcommand{\myBookTitleEnglish}{Detection of Anxiety, Depression and Eating Disorders Using Large Language Models (LLMs): A Comparative Study Between BERT and State-of-the-Art Models}
\newcommand{\myThesisKeywords}{Ansiedad, Depresión, Trastornos alimentarios, Procesamiento del lenguaje natural (PLN), Grandes modelos de lenguaje (LLM)} % (máximo de cinco)
\newcommand{\myThesisKeywordsEnglish}{Anxiety, Depression, Eating Disorders, Natural Language Processing (NLP), Large Language Models (LLMs)} % (up to a maximum of five)
\newcommand{\myConfidentialContent}{No} % This can be Yes or No, used
                                        % in MUII as of July 2021

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Author data
\newcommand{\myAuthorName}{Andrés}
\newcommand{\myAuthorSurname}{Corbacho Sánchez}
\newcommand{\myAuthorFullName}{\myAuthorName{} \myAuthorSurname{}}
\newcommand{\myAuthorGender}{male} 
\newcommand{\myAuthorEmail}{andres.corbacho@edu.uah.es}
\newcommand{\myAuthorDNI}{09822062-G}
% Personal details for the anteproyecto request, not required in some cases
\newcommand{\myAuthorStreet}{Avenida Miguel de Unamuno, 10, 5ºC}
\newcommand{\myAuthorCity}{Alcalá de Henares}
\newcommand{\myAuthorPostalCode}{28806}
\newcommand{\myAuthorProvince}{Madrid}
\newcommand{\myAuthorTelephone}{640896276}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Advisor data
\newcommand{\myAcademicTutorFullName}{Adrián Domínguez Díaz} 
...
\newcommand{\myAcademicTutorPosition}{Profesor Ayudante Doctor}
\newcommand{\myAcademicTutorEmail}{adrian.dominguez@uah.es}
...
\newcommand{\myDepartment}{Ciencias de la Computación}
\newcommand{\myDepartmentEnglish}{Computer Science}
...
\newcommand{\myTribunalFirstSpokespersonGender}{female}
...
\newcommand{\myTribunalAlternateMemberGender}{female}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Calendar dates 
\newcommand{\myThesisProposalDate}{17 de novienmbre de 2025} % "Anteproyecto" date
